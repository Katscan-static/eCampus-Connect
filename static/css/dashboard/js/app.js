...
function timeTableAll(){
    ...
    setData(today);
    document.querySelector('.timetable div h2').innerHTML = "This Month Timetable";
}
...
document.querySelector('.timetable div h2').innerHTML = "This Month Timetable"; //To prevent overwriting the heading on loading;
